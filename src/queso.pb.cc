...
void protobuf_AssignDesc_queso_2eproto() {
  ...
  static const int Instruction_offsets_[16] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Instruction, pc_),
  };
...
void protobuf_AddDesc_queso_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "\001(\004\022\r\n\005count\030\006 \002(\r\"\326\003\n\013Instruction\022\035\n\006op"
...
const int Instruction::kPcFieldNumber;
#endif  // !_MSC_VER
...
void Instruction::SerializeWithCachedSizes(
  ...
  // optional uint64 pc = 16;
  if (has_pc()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt64(16, this->pc(), output);
  }
...
::google::protobuf::uint8* Instruction::SerializeWithCachedSizesToArray(
  ...
  // optional uint64 pc = 16;
  if (has_pc()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt64ToArray(16, this->pc(), target);
  }
